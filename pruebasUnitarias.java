...
class pruebasUnitarias {
	...
	@Test
	@DisplayName("TIPO DE TRIANGULO escaleno")
	void tipoTrianguloEscaleno() {
		assertEquals("escaleno",trabajo.tipoTriangulo(4,5,2));//verificamos si la entrada cumple con el if en este caso con el else
	...
	@Test
	@DisplayName("AUMENTO--120")
	void aumentoTotal120() {
		assertEquals(120,trabajo.aumentoTotal(100,20));
